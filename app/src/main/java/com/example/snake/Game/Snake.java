...
public class Snake {
    ...
    public Snake(Bitmap bm, int x, int y, int length) {
        ...
        setMove_right(true);///изночально бежит вправо
        arrPartSnake.add(new PartSnake(bm_head_right, x, y));/// змея по умолчанию
